                        ...
                        }
                        {
                            isLoggedIn && <>
                                <div className="text-white gap-4 hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                                    ...
                                    <div>
                                        <img src={loggedInUser.image} className="w-8 h-8" alt="user profile" />
                                    </div>
                    ...
                    <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                        ...
                        <div className="py-6 px-5 space-y-6">
                            <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                                <a href="#" className="text-base font-medium text-white hover:text-gray-700"> Pricing </a>

                                <a href="#" className="text-base font-medium text-white hover:text-gray-700"> Docs </a>

                                <a href="#" className="text-base font-medium text-white hover:text-gray-700"> Help Center </a>

                                <a href="#" className="text-base font-medium text-white hover:text-gray-700"> Guides </a>

                                <a href="#" className="text-base font-medium text-white hover:text-gray-700"> Events </a>

                                <a href="#" className="text-base font-medium text-white hover:text-gray-700"> Security </a>
                            </div>
                            <div>
