        ...
        const handleClickOutside = (event) => {
            if (refDropDown.current && !refDropDown.current.contains(event.target)) {
                ...
                if (
                    ...
                    event.target.id !== "search-bar-trigger"
                ) {
    ...
    return (
        <>
            <div className="relative bg-netflix-dark">
                <div className="max-w-[90%] mx-auto sm:px-0">
                            ...
                            <div className="flex gap-4">
                                ...
                                {isLoggedIn && (
                                    <div
                                        ...
                                        onClick={dropDownNavbarHandler}
                                    >
                                        <img
                                            id="userProfile"
                                            src={userImage.getImage(loggedInUser.photoURL)}
                                            className="w-8 h-8"
                                            alt="user profile"
                                        />
                                    </div>
                        ...
                        {isLoggedIn && (
                            <>
                                <nav className="hidden md:flex space-x-10 ">
                                    <a
                                        href="/"
                                        className="text-base font-medium text-white hover:text-netflix-red"
                                    >
                                        Home
                                    </a>
                                    <a
                ...
                {isLoggedIn && (
                    <div
                        ref={refDropDown}
                        className={`z-10 w-44 bg-netflix-dark border-t-2 border-netflix-blue rounded divide-y divide-gray-600 shadow block shadow-neutral-800 ${!showDropdown && "hidden"
                            }`}
                    ...
                    >
                        ...
                        <div className="py-1">
                            <Link
                                to="/logout"
                                className="block py-2 px-4 text-sm text-white hover:bg-netflix-blue dark:text-gray-200 dark:hover:text-white"
                            >
                                Log out
                            </Link>
                        </div>
